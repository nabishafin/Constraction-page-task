                ...
                <aside className="text-white">
                    ...
                    <div className="mt-4">
                        <div className="flex gap-2 mb-2">
                            <img className="p-1 bg-white rounded-full" src="../../../public/Assets/call.png" alt="" />
                            <p className="mt-1">+40 123 456 789</p>
                        </div>
                        <div className="flex gap-2 mb-2">
                            <img className="p-1 bg-white rounded-full" src="../../../public/Assets/massage.png" alt="" />
                            <p className="mt-1">contact@hireandfire.agency</p>
                        </div>
                        <div className="flex gap-2 mb-2">
                            <img className="p-1 bg-white rounded-full" src="../../../public/Assets/location.png" alt="" />
            ...
            <div className="flex flex-col gap-8 p-20 mr-40 text-white lg:ml-40 lg:justify-between lg:flex-row">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex gap-8 sm :">
                        <img className="p-1 bg-white rounded-full" src="../../../public/Assets/call.png" alt="" />
                        <img className="p-1 rounded-full bg-rose-700" src="../../../public/Assets/call.png" alt="" />
                        <img className="p-1 bg-white rounded-full" src="../../../public/Assets/massage.png" alt="" />
                    </div>
                </div>
