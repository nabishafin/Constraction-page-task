...
import countyIcon from "../../../public/Assets/Country Icon.png";
        ...
        <div className="font-bold lg:mr-20 lg:ml-20">
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to="/" className="text-xl btn btn-ghost "><img className="hidden sm : lg:block" src={logo} alt="" /></Link>
                </div>
